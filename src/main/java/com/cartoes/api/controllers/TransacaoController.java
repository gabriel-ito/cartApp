...
public class TransacaoController {
	...
	public ResponseEntity<Response<List<TransacaoDto>>> buscarPorNumeroCartao(
		...
		try {
			...
			log.info("Controller: buscando por numero do cartão: {}", numeroCartao);
			Optional<List<Transacao>> listaTransacao = transacaoService.buscarPorNumeroCartao(numeroCartao);
			response.setDados(ConversaoUtils.ConverterLista(listaTransacao.get()));
	...
	/**
	 * Persiste uma transação na base
	 * 
